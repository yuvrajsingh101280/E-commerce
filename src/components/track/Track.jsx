      ...
      <div className="container mx-auto px-10 py-10 md:py-14">
        ...
        <div className="flex flex-wrap text-center -m-4">
          ...
          <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
            <div className="border-2 hover:shadow-xl cursor-pointer hover:shadow-gray-200 border-gray-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg">
              <svg
